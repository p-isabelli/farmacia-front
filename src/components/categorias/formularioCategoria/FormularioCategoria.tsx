...
function FormularioCategoria() {
    ...
    return (
        <div className="container flex flex-col items-center justify-center mx-auto">
            ...
            <form className="w-1/2 flex flex-col gap-4" onSubmit={gerarNovaCategoria}>
                <div className="flex flex-col gap-2 text-center">
                    ...
                    <input
                        ...
                        placeholder="Nome"
                        name='nome'
                        className="border-2 border-verde rounded p-2"
                ...
                <button
                    className="rounded text-white bg-verde hover:bg-verdeEscuro duration-300 w-1/2 py-2 mx-auto block"
                    type="submit"
                >
            ...
            <button className="rounded text-white bg-verde hover:bg-verdeEscuro duration-300 w-1/4 py-2 mx-auto block mt-4" onClick={retornar}>Voltar</button>
        </div>
    );
}
